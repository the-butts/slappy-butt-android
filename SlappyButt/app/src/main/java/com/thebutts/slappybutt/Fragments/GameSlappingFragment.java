...
/**
 * Created by Ivko on 17-Jan-16.
 */
public class GameSlappingFragment extends Fragment {
    ...
    private TextView mScoreContainer;
    ...
    private TextView mTimeToSlapContainer;

    private GoogleApiClient client;

    public GameSlappingFragment() {
        // Required empty public constructor
    }

    public static GameSlappingFragment newInstance(
        ...
        GameSlappingFragment fragment = new GameSlappingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.inflatedView = inflater.inflate(R.layout.fragment_game_slapping, container, false);

        Log.d("in fragment get view", inflatedView.toString());
        ...
        this.setNewSlapTimeOut((long) 3000);
    ...
    private void setupAnimationsContainers() {
        ...
        this.mActivityLayout = (LinearLayout) this.inflatedView.findViewById(R.id.freeSlapFragmentBackground);
        this.mScoreContainer = (TextView) this.inflatedView.findViewById(R.id.tv_score_container);
        this.mTimeToSlapContainer = (TextView) this.inflatedView.findViewById(R.id.tv_time_left_value);
    ...
    void setupUiEvents() {
//        gLibrary = GestureLibraries.fromRawResource(inflatedView.getContext(), R.raw.gestures);
//
//        if (!gLibrary.load()) {
//            Toast.makeText(inflatedView.getContext(), "Error loading gestures", Toast.LENGTH_SHORT).show();
//        }
//
//        mGestureOverlay = (GestureOverlayView) inflatedView.findViewById(R.id.gesture_overlay);
//
...
//
//
//                    GameSlappingFragment.this.mGestureListener.setVisibility(View.GONE);
//
//                    GameSlappingFragment.this.mTorsoContainer.setBackgroundResource(mTorsoImages.getResourceId(index, -1));
//                }
//            }
//        });
        ...
        final GestureDetectorCompat doubleTapGestureDetector = new GestureDetectorCompat(getActivity(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                GameSlappingFragment.this.setRandomBackGround();
                return true;
            }
            ...
            public void onLongPress(MotionEvent e) {
                ...
                GameSlappingFragment.this.mGestureListener.setVisibility(View.VISIBLE);
                super.onLongPress(e);
            }
        });

        GameSlappingFragment.this.mTorsoContainer.setOnTouchListener(new View.OnTouchListener() {
        ...
        final GestureDetector gestureDetector = new GestureDetector(getActivity(), new SwipeGestureDetector() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                switch (getSlope(e1.getX(), e1.getY(), e2.getX(), e2.getY())) {
                    case 1:
                        Log.d(LOGTAG, "top");
                        GameSlappingFragment.this.onClickFlintUp();
                        return true;
                    case 2:
                        Log.d(LOGTAG, "left");
                        GameSlappingFragment.this.onClickFlintLeft();
                        return true;
                    case 3:
                        GameSlappingFragment.this.onClickFlintDown();
                        Log.d(LOGTAG, "down");
                        return true;
                    case 4:
                        GameSlappingFragment.this.onClickFlintRight();
                        Log.d(LOGTAG, "right");
                        return true;
                }
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                if (x < GameSlappingFragment.this.mScreenWidth / 2) {
                    GameSlappingFragment.this.onClickBtnLeftButt();
                } else {
                    GameSlappingFragment.this.onClickBtnRightButt();
                }
            ...
            public boolean onDown(MotionEvent e) {
                ...
                GameSlappingFragment.this.mScore += 1;

                if (GameSlappingFragment.this.mScoreContainer != null) {
                    GameSlappingFragment.this.mScoreContainer.setText(GameSlappingFragment.this.mScore.toString());
                }

                Log.d(GameSlappingFragment.this.TAG, "huc deiba");
                Log.d(GameSlappingFragment.this.TAG, GameSlappingFragment.this.mScore.toString());

                GameSlappingFragment.this.mTimer.cancel();
                GameSlappingFragment.this.mTimer.start();


                if (GameSlappingFragment.this.mScore >= 1000) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 100);
                } else if (GameSlappingFragment.this.mScore >= 800) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 150);
                } else if (GameSlappingFragment.this.mScore >= 600) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 200);
                } else if (GameSlappingFragment.this.mScore >= 400) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 250);
                } else if (GameSlappingFragment.this.mScore >= 200) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 300);
                } else if (GameSlappingFragment.this.mScore >= 100) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 400);
                } else if (GameSlappingFragment.this.mScore >= 50) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 500);
                } else if (GameSlappingFragment.this.mScore >= 20) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 1000);
                } else if (GameSlappingFragment.this.mScore >= 10) {
                    GameSlappingFragment.this.setNewSlapTimeOut((long) 2000);
                }
        ...
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(getActivity(), new ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            public boolean onScale(ScaleGestureDetector detector) {
                ...
                if (scaleFactor > 1) {
                    GameSlappingFragment.this.onClickPinchOut();
                    return true;
                } else {
                    GameSlappingFragment.this.onClickPinchIn();
                    return false;
                }
            }
        ...
        this.mSlappingFrame.setOnTouchListener(scaleGestureListener);
    }
    ...
    private void updateTimer(float time) {
        ...
        this.mTimeToSlapContainer.setText(String.format("%s.%s", seconds, milliseconds));
    }

    private void setNewSlapTimeOut(Long timeOut) {
        ...
        this.mTimer = new CountDownTimer(timeOut, 10) {

            public void onTick(long millisUntilFinished) {
                GameSlappingFragment.this.updateTimer(millisUntilFinished);
            }
